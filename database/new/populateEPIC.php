...
$f = fopen("../../json/EPIC.json", "r") or die("Unable to open file!");
$file = file_get_contents("../../json/EPIC.json");
$json = json_decode($file);

// loop through libraries (die after ESAS)
